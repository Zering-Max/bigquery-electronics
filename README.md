...
Voici les tables :
- **int_categories_table** : Elle permettait d'aggréger correctement pour la suite les catégories, sous-catgéories, voire sous-sous-catégories car ces 'subtilités' dans la table brut étaient toutes mélangées.
